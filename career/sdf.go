...
func SystemDefenceNavy() Career {
	return Career{
		...
		Benefits: [7]BenefitRow{
			...
			{Cash: 2500, Other: unimplemented("a weapon of the character's choice")},
...
func SystemDefenceTroopers() Career {
	return Career{
		...
		Benefits: [7]BenefitRow{
			...
			{Cash: 2500, Other: unimplemented("a weapon of the character's choice")},
			{Cash: 5000, Other: relationship(Contact, 1, "")},
			{Cash: 10000, Other: unimplemented("armor of the character's choice")},
		},
...
func SystemDefenceWetNavy() Career {
	return Career{
		...
		Benefits: [7]BenefitRow{
			...
			{Cash: 20000, Other: unimplemented("a pension of 2d6 x 10,000 credits")},
		},
