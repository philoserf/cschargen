...
func Arts() Career {
	return Career{
		...
		Benefits: [7]BenefitRow{
			...
			{Cash: 20000, Other: unimplemented("three pieces of art, 2d6 x 10,000 credits each")},
			{Cash: 50000, Other: unimplemented("six pieces of art, 2d6 x 10,000 credits each")},
		},
		Mishaps: artsMishaps(),
		Events:  artsEvents(),
	}
