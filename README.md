...
The schema is versioned and so is the policy, and a record carries both. A record
replays under a later version where the engine has not changed what a seed
produces, and names the value that moved where it has.
